...
//        EasyMock.expectLastCall().andReturn(ArrayzImpl.fromObjects(mockClassBoundary));
//        EasyMock.expect(mockMethodParam.getArguments());
//        EasyMock.expectLastCall().andReturn(ArrayzImpl.fromObjects(STRING_INSTANCE));
...
//        EasyMock.expect(mockMethodParam.getParameterTypes());
//        EasyMock.expectLastCall().andReturn(ArrayzImpl.fromObjects(mockClassBoundary1, mockClassBoundary2, mockClassBoundary3));
//
...
//        EasyMock.expect(mockMethodParam.getArguments());
//        EasyMock.expectLastCall().andReturn(ArrayzImpl.fromObjects(mockPerson, mockShape, mockSquare));
//
