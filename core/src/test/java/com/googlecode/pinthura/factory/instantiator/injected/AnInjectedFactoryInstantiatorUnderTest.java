...
public final class AnInjectedFactoryInstantiatorUnderTest {
    ...
    public void setup() {
        ...
        instantiator = new InjectedFactoryInstantiator(mockAnnotatedClassExtractor, mockInjectedFactoryResolver);
    }
