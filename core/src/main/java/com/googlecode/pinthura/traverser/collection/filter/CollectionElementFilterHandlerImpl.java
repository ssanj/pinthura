...
public final class CollectionElementFilterHandlerImpl<Input, Output> implements CollectionElementHandler<Input, Output> {

    private final CollectionElementFilter<Input> filter;
    private final CollectionElementHandler<Input, Output> handler;

    public CollectionElementFilterHandlerImpl(final CollectionElementFilter<Input> filter,
