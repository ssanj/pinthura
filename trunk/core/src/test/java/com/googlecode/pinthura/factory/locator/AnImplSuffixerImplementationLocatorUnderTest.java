...
public final class AnImplSuffixerImplementationLocatorUnderTest {

    private final IMocksControl mockControl = EasyMock.createControl();

    private ImplementationLocator locator;
    private ClassBoundary mockClassBoundary;

    @Before
    public void setup() {
        locator = new ImplSuffixerImplementationLocator();
    ...
    private void expectImplementation(final String interfaceClass, final String implementationClass) {
        ...
        assertThat(locator.locateImplementation(mockClassBoundary), equalTo(implementationClass));
