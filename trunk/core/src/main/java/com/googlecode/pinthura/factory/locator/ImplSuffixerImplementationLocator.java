...
public final class ImplSuffixerImplementationLocator implements ImplementationLocator {

    private static final String DEFAULT_SUFFIX  = "Impl";

    public String locateImplementation(final ClassBoundary interfaceClass) {
