...
//        mockControl.replay();
//
//        Class<String> aClass = (Class<String>) new InstanceCreatorImpl(mockFilterLink).filter(mockMethodParam);
...
//        assertThat(new InstanceCreatorImpl(mockFilterLink).getFilterName(), equalTo("Class Locator Chain"));
//    }
}
