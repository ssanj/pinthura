        ...
        try {
            ...
            assertThat(e.getMessage(), equalTo(
                    exceptionMessageBuilder.withExpectedClass(ArrayIndexOutOfBoundsException.class).
                                            andReceivedClass(PathEvaluatorException.class).build()));
        ...
        try {
            ...
            assertThat(e.getMessage(),
                    equalTo(exceptionMessageBuilder.withExpectedClass(NullPointerException.class).
                                                    andReceivedClass(FileNotFoundException.class).build()));
        }
    }
        ...
        try {
            ...
            fail("Expected AssertionError.");
             ...
             assertThat(ae.getMessage(),
                     equalTo(exceptionMessageBuilder.withExpectedString(message).
                             andReceivedString(invalidMessage).
                                                    build()));
        }
    }
