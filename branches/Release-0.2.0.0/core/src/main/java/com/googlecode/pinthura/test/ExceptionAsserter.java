...
public interface ExceptionAsserter {
    ...
    <EX, NEX> void assertException(final Class<EX> expectedExceptionClass, final Class<NEX> expectedNestedExceptionClass,
                                                 final String message, final ExceptionAsserterImpl.Exceptional ex);

    <EX, NEX> void assertException(final Class<EX> expectedExceptionClass, final Class<NEX> expectedNestedExceptionClass,
                                                 final ExceptionAsserterImpl.Exceptional ex);

    <EX> void assertException(final Class<EX> expectedExceptionClass, final ExceptionAsserterImpl.Exceptional ex);

    <EX> void assertException(final Class<EX> expectedExceptionClass, final String message,
                                            final ExceptionAsserterImpl.Exceptional ex);
